...
<link rel="stylesheet" href="resources/css/jqtransform.css">
<link rel='shortcut icon' href='resources/resources/images/favicon.ico'>
<!--JS-->
<script src="resources/js/jquery-1.7.1.js"></script>
<script src="resources/js/scripts.js"></script>
<script src="resources/js/MathUtils.js"></script>
<script src="resources/js/bgStretch.js"></script>
<script src="resources/js/sImg.js"></script>
...
<script src="resources/js/uCarousel.js"></script>
<script src="resources/js/jquery.jqtransform.js"></script>
<!-- Fancybox -->
<script src="resources/js/FancyBox.js"></script>
<script src="resources/js/jquery.fancybox-1.3.4.js"></script>
<!--Form & Map-->
